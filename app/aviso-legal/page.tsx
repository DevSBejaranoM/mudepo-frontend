const AvisoLegalPage = () => {
  return (
    <div className="p-8 bg-white text-gray-700 md:mx-24">
      <h1 className="text-2xl font-bold my-16 text-center">AVISO LEGAL</h1>
      <h1 className="text-2xl font-bold mb-4">
        LEY DE LOS SERVICIOS DE LA SOCIEDAD DE LA INFORMACIÓN (LSSI)
      </h1>
      <p className="mb-4">
        MUDEPO 1988 SL, responsable del sitio web, en adelante RESPONSABLE, pone
        a disposición de los usuarios el presente documento, con el que pretende
        dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11
        de julio, de Servicios de la Sociedad de la Información y de Comercio
        Electrónico (LSSICE), BOE N.o 166, así como informar a todos los
      ...
      <p className="mb-4">
        MUDEPO 1988 SL se reserva el derecho de modificar cualquier tipo de
        ...
        web de MUDEPO 1988 SL.
      </p>

      <h2 className="text-xl font-bold mt-8 mb-4">1. DATOS IDENTIFICATIVOS</h2>
      <p className="mb-4">
        Nombre de dominio: mudepo-frontend.vercel.app/ <br />
        Nombre comercial: MUDEPO <br />
        Denominación social: MUDEPO 1988 SL <br />
        NIF: B16468167 <br />
        Domicilio social: PARQUE EUROPA 5, 09001 BURGOS <br />
        Teléfono: 666320548 <br />
        E-mail: info@mudepo.es <br />
        HOJA BU 19798 IRUS 1000420877980 Folio Electrónico Inscripción 1
      </p>
      ...
      <p className="mb-4">
        ...
        funcionamiento, los diseños, logotipos, texto y/o gráficos, son
      ...
      <p className="mb-4">
        ...
        redirigir al sitio web principal de mudepo-frontend.vercel.app/.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        a través del correo electrónico info@mudepo.es.
      </p>
      ...
      <p className="mb-4">
        ...
        la información publicada en su sitio web siempre que no tenga
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">Uso de Cookies</h3>
      <p className="mb-4">
        ...
        con la única finalidad de hacer más eficaz la navegación, y desaparecen
        al terminar la sesión del usuario. En ningún caso, estas cookies
        proporcionan por sí mismas datos de carácter personal y no se utilizarán
      ...
      <p className="mb-4">
        ...
        finalidad de que la navegación sea más sencilla, permitiendo, por
        ejemplo, el acceso de los usuarios que se hayan registrado previamente a
        las áreas, servicios, promociones o concursos reservados exclusivamente
        a ellos sin tener que registrarse en cada visita.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        analíticos y para mostrarle publicidad personalizada en base a un perfil
        elaborado a partir de sus hábitos de navegación (por ejemplo, páginas
        visitadas). A todo usuario que visita la web se le informa del uso de
        estas cookies mediante un banner flotante. En el caso de aceptar su uso,
        el banner desaparecerá, aunque en todo momento podrá revocar el
        consentimiento y obtener más información consultando nuestra Política de
        cookies.
      </p>
      <p className="mb-4">
        El usuario tiene la posibilidad de configurar su navegador para ser
        alertado de la recepción de cookies y para impedir su instalación en su
        equipo. Por favor, consulte las instrucciones de su navegador para
        ampliar esta información.
      </p>

      <h3 className="text-lg font-semibold mt-6 mb-2">Política de enlaces</h3>
      <p className="mb-4">
      ...
      <h3 className="text-lg font-semibold mt-6 mb-2">Direcciones IP</h3>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        del domicilio del USUARIO o el lugar del cumplimiento de la obligación.
      </p>
    </div>
  );
};
